...
public class JdbcUriToolsTest {
    ...
    public void test_mariadb() {
        ...
        Assertions.assertEquals("jdbc:mariadb://localhost:3306/DB?password=myPassword&user=root", jdbcUri.toUri());
    }
    ...
    public void test_mongo_full() {
        ...
        Assertions.assertEquals("jdbc:mongodb://root:ABC@localhost:27017,localhost:27018,localhost:27019/myDb?connectTimeoutMS=300000&replicaSet=rs", jdbcUri.toUri());
    }
    ...
    public void test_mongo_local() {
        ...
        Assertions.assertEquals("jdbc:mongodb://localhost:27017", jdbcUri.toUri());
    }
