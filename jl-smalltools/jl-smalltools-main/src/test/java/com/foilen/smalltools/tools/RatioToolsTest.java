...
public class RatioToolsTest {
    ...
    public void testGetDownScaleByMaxSide_byLongerSide_widthWise() {
        ...
        Assertions.assertEquals(0.75f, RatioTools.getDownScaleByMaxSide(400, 200, 300, 200), 0.0001f);
    }
    ...
    public void testGetDownScaleByMaxSide_byLongerSide_heightWise() {
        ...
        Assertions.assertEquals(0.75f, RatioTools.getDownScaleByMaxSide(200, 400, 300, 200), 0.0001f);
    }
    ...
    public void testGetDownScaleByMaxSide_byShorterSide_widthWise() {
        ...
        Assertions.assertEquals(0.60f, RatioTools.getDownScaleByMaxSide(200, 400, 300, 120), 0.0001f);
    }
    ...
    public void testGetDownScaleByMaxSide_byShorterSide_heightWise() {
        ...
        Assertions.assertEquals(0.60f, RatioTools.getDownScaleByMaxSide(400, 200, 300, 120), 0.0001f);
    }
    ...
    public void testGetDownScaleByMaxSide_alreadyFit_1() {
        // Initially 290x100
        // Fit in max 300x120
        Assertions.assertEquals(1f, RatioTools.getDownScaleByMaxSide(290, 100, 300, 120), 0.0001f);
    }
    ...
    public void testGetDownScaleByMaxSide_alreadyFit_2() {
        // Initially 100x290
        // Fit in max 300x120
        Assertions.assertEquals(1f, RatioTools.getDownScaleByMaxSide(100, 290, 300, 120), 0.0001f);
    }
    ...
    public void testGetDownScaleByMaxHeight_smaller() {
        ...
        Assertions.assertEquals(1f, RatioTools.getDownScaleByMaxHeight(400, 200, 300), 0.0001f);
    }
    ...
    public void testGetDownScaleByMaxHeight_reduce() {
        ...
        Assertions.assertEquals(0.75f, RatioTools.getDownScaleByMaxHeight(200, 400, 300), 0.0001f);
    }
    ...
    public void testGetDownScaleByMaxWidth_reduce() {
        ...
        Assertions.assertEquals(0.75f, RatioTools.getDownScaleByMaxWidth(400, 200, 300), 0.0001f);
    }
    ...
    public void testGetDownScaleByMaxWidth_smaller() {
        ...
        Assertions.assertEquals(1f, RatioTools.getDownScaleByMaxWidth(200, 400, 300), 0.0001f);
    }
