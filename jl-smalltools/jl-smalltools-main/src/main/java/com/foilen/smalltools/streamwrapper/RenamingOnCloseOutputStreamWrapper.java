...
public class RenamingOnCloseOutputStreamWrapper extends AbstractOutputStreamWrapper {
     ...
     *
     * @param wrappedOutputStream   the output stream to wait for close
     * @param renameSourceFile      the file that will be renamed when the stream is closed
     * @param renameDestinationFile the name to rename to
     */
     ...
     * Tells if the file will be discarded or renamed when closing the stream.
     *
     * @param deleteOnClose true if the file will be discarded ; false if will be renamed
     */
