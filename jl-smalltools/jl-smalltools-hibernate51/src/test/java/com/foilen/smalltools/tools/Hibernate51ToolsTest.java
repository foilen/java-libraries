...
public class Hibernate51ToolsTest {
    ...
    public void testGenerateSqlSchema_WithoutUnderscore() throws Exception {
        ...
        Hibernate51Tools.generateSqlSchema(MySQLDialect.class, outputSqlFile, false, "com.foilen.smalltools.tools.test.entities");
    ...
    public void testGenerateSqlSchema_WithUnderscore() throws Exception {
        System.setProperty("hibernate.dialect.storage_engine", "innodb");
        String outputSqlFile = File.createTempFile("output", ".sql").getAbsolutePath();
        Hibernate51Tools.generateSqlSchema(MySQLDialect.class, outputSqlFile, true, "com.foilen.smalltools.tools.test.entities");
